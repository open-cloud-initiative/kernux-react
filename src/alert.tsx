  ...
  return (
    <div
      ...
      className={clsx(
        "kern-alert",
        "my-2",
        "kern-alert--" + props.type || defaultType,
        props.className,
      )}
      role="alert"
    >
      <div
        className={
          props.content ? "kern-alert__header" : "kern-alert__header !p-0"
        }
      >
        <span
          className={clsx(
            "kern-icon",
            "kern-icon--" + props.type || defaultType,
          )}
          aria-hidden="true"
        ></span>
        <span className="kern-title">
          {props.title || defaultTitle[props.type || defaultType]}
        </span>
      </div>
      {props.content && (
